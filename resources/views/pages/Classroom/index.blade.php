...
@section('page-title')
  <x-page-title-vertical :title="'Data Kelas'" :btnBack="false" :redirect="'/basis-pengetahuan'"></x-page-title-vertical>
@endsection

@section('content')
  <div class="card">
    <div class="card-header">
      <a href="{{ route('classroom.create') }}" class="btn btn-icon icon-left btn-primary btn-sm">

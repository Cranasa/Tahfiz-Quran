...
@section('page-title')
  <x-page-title-vertical :title="'Data Ustad'" :btnBack="false" :redirect="''"></x-page-title-vertical>
@endsection

@section('content')
  <div class="card">
    <div class="card-header">
      <a href="{{ route('ustad.create') }}" class="btn btn-icon icon-left btn-primary btn-sm">
  ...
  <script>
    $(document).ready(function(){
      ...
      $('.btn-delete').on('click', function(){
        ...
        $('#form-delete').attr('action', 'ustad/delete/' + $(this).data('id'));
      });
    });
  </script>
@endpush